            ...
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                    <c:forEach var="listFamille" items="${listCat.rows}">
                  <li class="mb-2"><a class="reset-anchor" href="Shop?idfam=${listFamille.numFam}"><c:out value="${listFamille.nomFam}" /></a></li>
                    </c:forEach>
                </ul>
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white bg-"></div><a class="d-block" href="detail?idProduit=${user.numPro}"><img class="img-fluid w-100" src="images/<c:out value="${user.photo}" />" alt="..."></a>
                      ...
                      <h6> <a class="reset-anchor" href="detail.html"><c:out value="${user.nomPro}" /></a></h6>
                      <p class="small text-muted">$<c:out value="${user.prixPro}" /></p>
                    </div>
                  </div>
                  </c:forEach>
