                ...
                <table class="table text-nowrap">
                  ...
                  <c:set var="ageTotal" value="${0}" />
                   <c:forEach var="listUser" items="${ listUser }">
                    <tr>
                    <c:set var="qt" value="${listUser.qte}" />
                      <th class="ps-0 py-3 border-light" scope="row">
                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html">    <img src="images/${listUser.pic}" width="240" height="300"/><!-- <img src="img/product-detail-3.jpg" alt="..." width="70"/> --></a>
                          <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.html">${listUser.nomProduit}</a></strong></div>
                        </div>
                      </th>
                      <td class="p-3 align-middle border-light">
                        <p class="mb-0 small">${listUser.pupro}</p>
                      ...
                      <td class="p-3 align-middle border-light">
                        <div class="border d-flex align-items-center justify-content-between px-3"><span class="small text-uppercase text-gray headings-font-family">Quantity</span>
                          <div class="quantity">
                           <!--  <button class="dec-btn p-0"><i class="fas fa-caret-left"></i></button> -->
                            <input class="form-control form-control-sm border-0 shadow-0 p-0" value="${listUser.qte}" type="text" />
                          <!--   <button class="inc-btn p-0"><i class="fas fa-caret-right"></i></button> -->
                          </div>
                        </div>
                      </td>
                      <td class="p-3 align-middle border-light">
                        <p class="mb-0 small">$${listUser.pupro*qt}</p>
                          <c:set var="a" value="${listUser.pupro*qt}" />
                         <c:set var="ageTotal" value="${ageTotal + a}" />
                      </td>
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center justify-content-between"><strong class="text-uppercase small font-weight-bold">Subtotal</strong><span class="text-muted small"></span></li>
                    <li class="border-bottom my-2"></li>
                    <li class="d-flex align-items-center justify-content-between mb-4"><strong class="text-uppercase small font-weight-bold">Total</strong><span>$${ageTotal}</span></li>
                    <li>
                      <form action="ValidateCmd" method="post">
                        <div class="input-group mb-0">
                          <input type="hidden" value="${ageTotal}" name=prixt>
                           <input type="hidden" value="${sessionScope.idClient}" name="id">
                          <button class="btn btn-dark btn-sm w-100" type="submit"> <i class="fas fa-gift me-2"></i>Valider</button>
                        </div>
                      </form>
                    </li>
                  </ul>
