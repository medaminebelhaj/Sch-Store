          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ms-auto">               
                <li class="nav-item"><a class="nav-link" href="Cart?id=<c:out value="${sessionScope.idClient}"/>"> <i class="fas fa-dolly-flatbed me-1 text-gray"></i>Cart<small class="text-gray fw-normal"></small></a></li>
          ...
          <div class="modal-content overflow-hidden border-0">
            ...
            <div class="modal-body p-0">
              <div class="row align-items-stretch">
                <div class="col-lg-6 p-lg-0"><a class="glightbox product-view d-block h-100 bg-cover bg-center" style="background: url(img/product-5.jpg)" href="images/${sessionScope.pic}" data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a><a class="glightbox d-none" href="img/product-5-alt-1.jpg" data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a><a class="glightbox d-none" href="img/product-5-alt-2.jpg" data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a></div>
                <div class="col-lg-6">
                  <div class="p-4 my-md-4">
                    ...
                    <h2 class="h4"><c:out value="${sessionScope.NomProduit}"/></h2>
        ...
        <div class="container">
          <div class="row mb-5">
              ...
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0 px-xl-2">
                  <div class="swiper product-slider-thumbs">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="images/${sessionScope.pic}" alt="..."></div>
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="images/${sessionScope.pic}" alt="..."></div>
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="images/${sessionScope.pic}" alt="..."></div>
                      <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="images/${sessionScope.pic}" alt="..."></div>
                    </div>
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="swiper product-slider">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="images/${sessionScope.pic}" data-gallery="gallery2" data-glightbox="Product item 1"><img class="img-fluid" src="images/${sessionScope.pic}" alt="..."></a></div>
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="images/${sessionScope.pic}" data-gallery="gallery2" data-glightbox="Product item 2"><img class="img-fluid" src="images/${sessionScope.pic}" alt="..."></a></div>
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="images/${sessionScope.pic}" data-gallery="gallery2" data-glightbox="Product item 3"><img class="img-fluid" src="images/${sessionScope.pic}"alt="..."></a></div>
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="images/${sessionScope.pic}" data-gallery="gallery2" data-glightbox="Product item 4"><img class="img-fluid" src="images/${sessionScope.pic}" alt="..."></a></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              ...
              <h1><c:out value="${sessionScope.NomProduit}"/></h1>
              <p class="text-muted lead">$<c:out value="${sessionScope.Prix}"/></p>
              <p class="text-sm mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut ullamcorper leo, eget euismod orci. Cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus. Vestibulum ultricies aliquam convallis.</p>
              
              <div class="row align-items-stretch mb-4">
                <div class="col-sm-5 pr-sm-0">
                 <!--  <div class="border d-flex align-items-center justify-content-between py-1 px-3 bg-white border-white"><span class="small text-uppercase text-gray mr-4 no-select">Quantity</sp -->
                    
                          <form method="POST" action="AddCart">
                               <label for="quantity">Quantity :</label>
                               <input type="number" id="quantity" name="qte" min="1" max="5">
                               <input type="hidden" name="idProduit" value="<c:out value="${sessionScope.idProduit}"/>">
                               <br><br>
                               <input type="submit" value="Add to cart" class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0">
                         
                      <!-- <button class="inc-btn p-0"><i class="fas fa-caret-right"></i></button> -->
                        </form>
                 
                </div>
                <!-- <div class="col-sm-3 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" type="submit">Add to cart</a></div> -->
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ms-2" href="#!"><c:out value="${sessionScope.Famille}"/></a></li>
